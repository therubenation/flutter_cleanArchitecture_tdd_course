...
void main() {
  ...
  // PART 1 ConcreteNumberTrivia Tests

  // we group tests based on the tested method
  group('getConcreteNumberTrivia', () {
    /// Feste Testdaten wie tNumber, tNumberTriviaModel, tNumberTrivia sind immutable
    /// einmal definieren reicht
    final tNumber = 1;
  ...
  // PART 2 RandomNumberTrivia Tests
